...
- Firmware `Packet TX` timing comparison against the ToA model on at least two modem presets
- 24-hour `airUtilTx` comparison against the live-preset ToA model (recalibrate if error exceeds 15%)
