...
| Durability/boot | #137's checked WAL/FULL software policy is verified; the original WAL/NORMAL wording remains in the historical snapshot. The owner requires battery backup for both machines. Power-loss qualification remains #44 and storage/energy, battery runtime and shutdown behavior remain #148; these hardware tasks do not block #137's software closure or promote whole-requirement acceptance. The local Pi's installed-service alignment and controlled reboot passed #136 on September 8, 2026, with [dated physical evidence](BOOT-RECOVERY-QUALIFICATION-2026-09-08.md); broader outage and soak gates remain open. |
