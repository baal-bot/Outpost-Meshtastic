...
| --- | --- | --- |
| Power interruption, intact readable store | Last committed transaction under the [WAL/FULL contract](COMMIT-DURABILITY.md) on flush-honoring storage; actual acknowledged-ID retention remains physically unqualified | Local service within 5 minutes of stable power, only after health/time/radio checks; physical #136/#137 remains open |
