...
| --- | --- | --- |
| Power interruption, intact readable store | Last durably committed transaction; `NORMAL` does not yet guarantee every acknowledged record survives power loss | Local service within 5 minutes of stable power, only after health/time/radio checks; physical #136/#137 remains open |
...
target recovery times. Those existing gates remain #135/#136/#137/#147/#148/#155/#157;
