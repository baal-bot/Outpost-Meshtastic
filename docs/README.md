...
Practical guides here describe the current implementation. `outpost-spec` contains the more
detailed intended product design.
...
The specification records intended design. Source, migrations, tests, and the feature maturity
guide describe what the current revision actually implements.
