...
| Community Watch | Transactional incident intake, authorized public-location corrections, reactions, operator changes and expiry with permanent local reference bindings; cross-Outpost origin/provenance reconciliation, human merge/unmerge, delivery-accountable and proximity-targeted responder alerts, member-relative mesh listings, retrying zero-recipient escalation, per-stage bounded repeats, all-clear, and maps. | Simulated | unreleased @ `HEAD` (2026-09-06); introduced `8323143` |
