...
- Automatic incident_events:1 delivery is software/simulation-tested, not physically qualified. Short single-peer examples reach exact storage receipts in 25 seconds (30 including full poll phase); parent plus note takes 55/60 seconds. These are declared-envelope samples, not arbitrary-load or mesh-wide/map G6 guarantees (#135).
