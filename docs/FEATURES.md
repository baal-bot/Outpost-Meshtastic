...
| Airtime and outbound delivery | Durable priority queue with budget-aware candidate selection, strict airtime configuration, emergency reserve, quiet hours, dedupe, pacing, receipts, restart recovery, and a delivery-health briefing comparing confirmed 24-hour channel outcomes and enrolled-radio receive quality with the preceding 14 days. | Automated-tested | unreleased @ `HEAD` (2026-09-05); introduced `3d65058` |
