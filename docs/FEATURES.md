...
| Command routing | DM/channel parsing, sessions, paging, trust checks, module gates, and bounded inbound workers. | Automated-tested | unreleased @ `HEAD` (2026-08-27); introduced `04e74ca` |
