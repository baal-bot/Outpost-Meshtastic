...
| Backup, restore, upgrade, and rollback | Online verified backups, rotation, quiesced web restore, passphrase-encrypted off-device bundles with configuration and selected secrets, fresh-directory offline restoration into a durable identity-fenced operator workbench, CI-gated signed releases, verified pre-activation updates, health-gated activation, and schema-aware rollback. | Automated-tested | unreleased @ `HEAD` (2026-09-07); introduced `df0ee14` |
