...
| Airtime and outbound delivery | Durable priority queue with commit-safe admission/supersession publication, budget-aware candidate selection, strict airtime configuration, emergency reserve, quiet hours, dedupe, pacing, receipts, restart recovery, and a delivery-health briefing comparing confirmed 24-hour channel outcomes and enrolled-radio receive quality with the preceding 14 days. | Automated-tested | unreleased @ `HEAD` (2026-09-06); introduced `3d65058` |
...
- Post-commit publication failure blocks egress until quiesced recovery; cancellation may still leave committed work. Shared outbox safety does not implement incident sender authorization or exact receipt matching (#135).
