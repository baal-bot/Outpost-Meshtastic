...
| Outpost federation | Pairing, authenticated framing, policy, producer-revision board/incident/alert reconciliation with durable pending-page receipts and bounded indexed discovery, peer services, encrypted mail relay, poison-resistant signed multi-hop custody with recoverable key rotation, transactional destination dispatch, and privacy-gated topology health. | Two-node field-tested | unreleased @ `HEAD` (2026-09-05); introduced `8f7219e` |
