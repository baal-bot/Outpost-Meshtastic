...
"$RUFF" format --check src tests \
  tools/build_release_metadata.py tools/benchmark_commit_policy.py \
  tools/eval_ai.py tools/bench_inference.py tools/check_capabilities.py tools/check_commands.py \
...
"$PYTHON" -m tools.check_requirements --check
